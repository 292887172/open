...
angular.module('Admin.app', ['ngRoute'])
...
+function ($) { "use strict";
  ...
  $(document).on('click.product.bjax.data-api', '[data-bjax], .nav-primary a', function (e) {
...
+function ($) {
  ...
  $(function(){
    ...
    var setHeight = function(){
      $('.product-fluid #nav > *').css('min-height', $(window).height()-60);
      return true;
    }
    setHeight();
