    ...
    DEFAULT_DATA = {"is_single_instruction": "true", "support_response_frame": "true", "support_serial": "true",
                    ...
                    "repeat_count": 3, "frame_content":
                        [{"name": "head", "title": "帧头", "is_enable": "true", "id": 1, "length": 2,
                          "value": "A55A"},
                         {"name": "serial", "title": "流水号", "is_enable": "true", "id": 2, "length": 1, "value": "00"},
                         {"name": "category", "title": "帧数据类型", "is_enable": "true", "id": 3, "length": 1,
                          "value": [{"value": "00", "desc": "心跳帧", "type": "heart"},
                         ...
                         {"name": "length", "title": "帧长", "is_enable": "true",
                          "id": 4, "length": 1, "value": "00"},
                         {"name": "data", "title": "数据域", "is_enable": "true",
                          "id": 5, "length": "N", "value": []},
                         {"name": "check", "title": "校验", "is_enable": "true",
                          "id": 6, "length": 1, "value": {"check_algorithm": "sum", "check_start": 1, "check_end": 5}}
                         ],
