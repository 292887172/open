...
def gen_app_default_conf(val):
    smoke = [
        {'isControl': 1, 'state': 1, 'time': '2017-08-01 09:20:19', 'name': '开关', 'corpMark': '', 'min': 0, 'max': 1,
         'mxsNum': '2', 'mxs': [{'desc': '开', 'data': '1'}, {'desc': '关', 'data': '0'}], 'corpName': '', 'paramType': 1,
         'mxsLength': '8', 'id': '1', 'Stream_ID': 'POWER'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:50:35', 'name': '风机', 'corpMark': '', 'min': 0, 'max': 4,
        ...
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:50:49', 'name': '照明', 'corpMark': '', 'min': 0, 'max': 1,
         'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '', 'paramType': 1,
         'mxsLength': '8', 'id': '3', 'Stream_ID': 'LAMP'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:50:49', 'name': '延时', 'corpMark': '', 'min': 0, 'max': 1,
         'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '', 'paramType': 1,
    ...
    stove = [
        ...
        {'isControl': 0, 'state': 1, 'time': '2017-07-27 16:52:56', 'name': '清洗时间', 'corpMark': 's', 'min': 0,
         'max': 65535, 'mxsNum': '0', 'mxs': [], 'corpName': '秒', 'paramType': 1, 'mxsLength': '16', 'id': '5',
         'Stream_ID': 'DISINFECT_DURATION'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:51:40', 'name': '烘干', 'corpMark': '', 'min': 0, 'max': 1,
         'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '', 'paramType': 1,
         'mxsLength': '8', 'id': '6', 'Stream_ID': 'DRY'},
        {'isControl': 0, 'state': 1, 'time': '2017-07-27 16:52:40', 'name': '烘干时间', 'corpMark': 's', 'min': 0,
         'max': 65535, 'mxsNum': '0', 'mxs': [], 'corpName': '秒', 'paramType': 1, 'mxsLength': '16', 'id': '7',
         'Stream_ID': 'DRY_DURATION'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '消毒', 'corpMark': '', 'min': 0, 'max': 1,
         'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '', 'paramType': 1,
         'mxsLength': '8', 'id': '8', 'Stream_ID': 'DISINFECT'},
        {'isControl': 0, 'state': 1, 'time': '2017-07-27 16:52:56', 'name': '消毒时间', 'corpMark': 's', 'min': 0,
         'max': 65535, 'mxsNum': '0', 'mxs': [], 'corpName': '秒', 'paramType': 1, 'mxsLength': '16', 'id': '9',
         'Stream_ID': 'DISINFECT_DURATION'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:52:23', 'name': '恒温', 'corpMark': '', 'min': 0, 'max': 1,
         'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '', 'paramType': 1,
    ...
    oven = [
        {'isControl': 1, 'state': 1, 'time': '2017-08-01 09:20:19', 'name': '开关', 'corpMark': '', 'min': 0, 'max': 1,
         'mxsNum': '2', 'mxs': [{'desc': '开', 'data': '1'}, {'desc': '关', 'data': '0'}], 'corpName': '', 'paramType': 1,
         'mxsLength': '8', 'id': '1', 'Stream_ID': 'POWER'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:50:35', 'name': '童锁', 'corpMark': '', 'min': 0, 'max': 1,
         'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '', 'paramType': 1,
         'mxsLength': '8', 'id': '2',  'Stream_ID': 'BODY_LOCK'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:50:49', 'name': '照明', 'corpMark': '', 'min': 0, 'max': 1,
         'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '', 'paramType': 1,
         'mxsLength': '1', 'id': '3', 'Stream_ID': 'LAMP'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:51:10', 'name': '工作模式', 'corpMark': '', 'min': 0,
         'max': 65535, 'mxsNum': '17',
        ...
        {'isControl': 0, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '时间下限', 'corpMark': 's', 'min': 0,
         'max': 65535, 'mxsNum': '0', 'mxs': [], 'corpName': '秒', 'paramType': 1, 'mxsLength': '16',
         'id': '5', 'Stream_ID': 'TIME_LOWER_LIMIT'},
        {'isControl': 0, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '建议工作时间', 'corpMark': 's', 'min': 0,
         'max': 65535, 'mxsNum': '0', 'mxs': [], 'corpName': '秒', 'paramType': 1, 'mxsLength': '16',
         'id': '6', 'Stream_ID': 'SUGGEST_TIME'},
        {'isControl': 0, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '时间上限', 'corpMark': 's', 'min': 0,
         'max': 65535, 'mxsNum': '0', 'mxs': [], 'corpName': '秒', 'paramType': 1, 'mxsLength': '16',
         'id': '7', 'Stream_ID': 'TIME_UPPER_LIMIT'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:51:40', 'name': '工作时间', 'corpMark': 's', 'min': 0,
         'max': 65535, 'mxsNum': '0', 'mxs': [], 'corpName': '秒', 'paramType': 1, 'mxsLength': '16',
         'id': '8', 'Stream_ID': 'WORK_TIME'},
        {'isControl': 0, 'state': 1, 'time': '2017-07-27 16:51:40', 'name': '剩余时间', 'corpMark': 's', 'min': 0,
         'max': 65535, 'mxsNum': '0', 'mxs': [], 'corpName': '秒', 'paramType': 1, 'mxsLength': '16',
         'id': '9', 'Stream_ID': 'REMAIN_TIME'},
        {'isControl': 0, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '温度下限', 'corpMark': '℃', 'min': 0,
         'max': 255, 'mxsNum': '0', 'mxs': [], 'corpName': '摄氏度', 'paramType': 1, 'mxsLength': '8',
         'id': '10', 'Stream_ID': 'TEMPE_LOWER_LIMIT'},
        {'isControl': 0, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '建议温度', 'corpMark': '℃', 'min': 0,
         'max': 255, 'mxsNum': '0', 'mxs': [], 'corpName': '摄氏度', 'paramType': 1, 'mxsLength': '8',
         'id': '11', 'Stream_ID': 'SUGGEST_TEMPE'},
        {'isControl': 0, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '温度上限', 'corpMark': '℃', 'min': 0,
         'max': 255, 'mxsNum': '0', 'mxs': [], 'corpName': '摄氏度', 'paramType': 1, 'mxsLength': '8',
         'id': '12', 'Stream_ID': 'TEMPE_UPPER_LIMIT'},
        {'isControl': 0, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '当前温度', 'corpMark': '℃', 'min': 0,
         'max': 255, 'mxsNum': '0', 'mxs': [], 'corpName': '摄氏度', 'paramType': 1, 'mxsLength': '8',
    ...
    fridge = [
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '智能模式', 'corpMark': '', 'min': 0,
         'max': 1, 'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '',
         'paramType': 1, 'mxsLength': '8', 'id': '1', 'Stream_ID': 'SMART_MODE'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '速冻模式', 'corpMark': '', 'min': 0,
         'max': 1, 'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '',
         'paramType': 1, 'mxsLength': '8', 'id': '2', 'Stream_ID': 'FAST_FREMODE'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '速冷模式', 'corpMark': '', 'min': 0,
         'max': 1, 'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '',
         'paramType': 1, 'mxsLength': '8', 'id': '3', 'Stream_ID': 'FAST_FRIMODE'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '变温室温度', 'corpMark': '℃', 'min': -20,
         'max': 20, 'mxsNum': '0', 'mxs': [], 'corpName': '摄氏度', 'paramType': 1, 'mxsLength': '8',
         'id': '4', 'Stream_ID': 'VAR_TEMP'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '冷冻室温度', 'corpMark': '℃', 'min': -20,
         'max': 20, 'mxsNum': '0', 'mxs': [], 'corpName': '摄氏度', 'paramType': 1, 'mxsLength': '8',
         'id': '5', 'Stream_ID': 'FRE_TEMP'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '冷藏室温度', 'corpMark': '℃', 'min': -20,
         'max': 20, 'mxsNum': '0', 'mxs': [], 'corpName': '摄氏度', 'paramType': 1, 'mxsLength': '8',
         'id': '6', 'Stream_ID': 'FRI_TEMP'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '变温室开关', 'corpMark': '', 'min': 0,
         'max': 1, 'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '',
         'paramType': 1, 'mxsLength': '8', 'id': '7', 'Stream_ID': 'VAR_POWER'},
        {'isControl': 1, 'state': 1, 'time': '2017-07-27 16:52:12', 'name': '冷冻室开关', 'corpMark': '', 'min': 0,
         'max': 1, 'mxsNum': '2', 'mxs': [{'desc': '关', 'data': '0'}, {'desc': '开', 'data': '1'}], 'corpName': '',
