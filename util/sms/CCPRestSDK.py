...
from util.sms.xmltojson import xmltojson
...
class REST:
    ...
    def sendTemplateSMS(self, to, datas, tempId):
        ...
        url = "https://" + self.ServerIP + ":" + str(
            self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/SMS/TemplateSMS?sig=" + sig
        # 生成auth
        src = self.AccountSid + ":" + self.Batch
        auth = base64_func(src).strip()
